...
local ThunderImageUI = Instance.new("ImageLabel")
        ...
        ThunderImageUI.Image = "http://www.roblox.com/asset/?id=13259071764"
...
function Update:Window(text,logo,keybind)
	local uihide = false
	local abc = false
	local logo = logo or 13259410877
	local currentpage = ""
...
Logo.Image = "rbxassetid://13259410877"
...
local postog12 = Instance.new("UIStroke")
 ...
 ImageLabel.Image = "rbxassetid://13259410877"
...
local Library = Update:Window("KX HUB ","")
------------------------------------------
...
--------------------------
local Main = Library:Tab("Bản thân1","rbxassetid://11446825283")
...
local Stats = Library:Tab("Cộng Điểm","rbxassetid://11447069304")
local P = Library:Tab("Người chơi","rbxassetid://11446900930")
local Teleport = Library:Tab("Bắn Tùm Lum","rbxassetid://11446920523")
local Dungeon = Library:Tab("Hack raid","rbxassetid://11446957539")
local DevilFruit = Library:Tab("Fruit+Esp","rbxassetid://11446965348")
local Shop = Library:Tab("Tiktok Shop","rbxassetid://6031265976")
local Misc = Library:Tab("Vớ vẩn","rbxassetid://11447063791")
local Op = Library:Tab("Trạng thái bản thân", "rbxassetid://7040410130")
--------------------------------------------------------------------

Setting:Label("Tham gia máy chủ của tôi để biết thêm thông tin!")

Setting:Line()

Setting:Button("Copy Link máy chủ",function()
 
 setclipboard("https://www.youtube.com/@hoapoytv")
 end)

Setting:Seperator(" Setting ")
Setting:Toggle("Tự động đặt điểm xuất hiện",true,function(value)
...
Setting:Toggle("Chống bị admin Ban",true,function(value)
 _G.AFK = value
 end)
...
Setting:Dropdown("Chọn phương pháp ", {
 "Phía sau","Dưới","trên"
},function(value)
 _G.Method = value
end)
...
Setting:Toggle("1Gom Quái [Extra+Lag]",false,function(value)
 _G.BringExtra = value
end)
        ...
        if _G.FastAttack then
            if typeof(xShadowx) == "table" then
                pcall(function()
                    ...
                    xShadowx.activeController.hitboxMagnitude = 99999999999
...
Setting:Toggle("Auto lấy Ken Haki ne",_G.Auto_Ken,function(vu)
	_G.Auto_Ken = vu
end)
spawn(function()
	while wait(2) do
...
Setting:Toggle("Auto ấn Click",false,function(value)
 _G.click = value
end)
...
Setting:Toggle("Màn hình trắng [ Booster FPS ]",_G.WhiteScreen,function(value)
...
local Minute = math.floor(GameTime/(60^1))%60
local Second = math.floor(GameTime/(60^0))%60
Time:Set("[Thời gian đã chơi] : giờ : "..Hour.."v : "..Minute.." giây : "..Second)
end
...
Main:Button("làm mới vũ khí nếu không thấy",function()
 SelectWeapona:Clear()
 for i,v in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do
...
Main:Toggle("Bắt đầu Đập",_G.Auto_Farm_Level,function(value)
...
Main:Seperator("Tự Động Biển Mới")
...
Main:Toggle("Trang trại tự động ngoại chất",_G.Auto_Farm_Ectoplasm,function(value)
...
Main:Toggle("Nhà máy trang trại ô tô",_G.AutoFactory,function(value)
...
Main:Seperator("Auto Second Sea")
...
Main:Dropdown("Chọn quái đập", tableMon, function(vu)
 SelectMonster = vu
 end)

Main:Toggle("đập quái đã chọn",_G.AutoFarmSelectMonster,function(vu)
...
Main:Seperator("cày điểm Mastery ")
 
Main:Toggle("Auto cày điểm Mastery trái ác quỷ",_G.AutoFarmFruitMastery,function(value)
 ...
 Main:Toggle("Auto cày điểm súng Mastery",_G.AutoFarmGunMastery,function(value)
...
Main:Toggle("Auto nhận nhiêm vụ Boss",true,function(value)
...
Main:Toggle("tự tìm đảo bí ẩn",false,function(value)
...
Main:Toggle("tự đổi máy chủ tìm đảo bí ẩn",false,function(value)
 _G.Mystichop = value
end)

Main:Seperator(" nhặt rương ")

Main:Toggle("Auto nhặt rương tốc độ",false,function(vu)
	_G.ChestBypass = vu
end)
...
Main:Toggle("Auto lấy rương Tween",_G.Grab_Chest,function(vu)
	Grab_Chest = vu
    StopTween(Grab_Chest)
	_G.Grab_Chest = vu
end)

Main:Button("dịch chuyển Tp Chest (Risk)",function()
 loadstring(game:HttpGet("https://raw.githubusercontent.com/scriptpastebin/raw/main/Chest_onoff"))()
 end)

if World3 then
Main:Seperator(" lấy xương chó ")

Main:Toggle("Auto Farm Xương",_G.Auto_Farm_Bone,function(value)
 _G.Auto_Farm_Bone = value
 StopTween(_G.Auto_Farm_Bone)
 end)

Main:Toggle("Auto random điểm xongw",_G.Auto_Trade_Bone,function(value)
...
Main:Button("Check xương", function()
...
spawn(function()
	while game:GetService("RunService").Heartbeat:wait() do
       ...
       Main:Toggle("Quan sát trang trại tự động",_G.AutoObservation,function(value)
    ...
    Main:Toggle("Quan sát trang trại tự động Hop",_G.AutoObservation_Hop,function(value)
...
local Notification = loadstring(game:HttpGet("https://raw.githubusercontent.com/Padupo/scrnohop/main/uisssubviet"))()
wait(1)
Notification:Notify(
...
Weapon:Toggle("hoàng tử bánh tự động",_G.Auto_Cake_Prince,function(value)
...
StopTween(_G.Auto_Cake_Prince)
	...
	Weapon:Toggle("Tự động mở Dough Dungeon",_G.Auto_Open_Dough_Dungeon,function(value)
...
Weapon:Toggle("Auto lấy Soul Guitar",_G.AutoNevaSoulGuitar,function(value)
...
Weapon:Toggle("Auto lấy Soul Guitar + đổi máy chủ Hop",false,function(value)
  _G.soulGuitarhop = value    
 end)

Weapon:Seperator(" song kiếm ố địt ")

Weapon:Toggle("Auto lấy CDK Quest(Not Working)",_G.AutoCdk,function(value)
 _G.AutoCdk = value
end)
...
Weapon:Toggle("Auto lấy Saber",_G.AutoSaber,function(value)
				_G.AutoSaber = value
			end)
 ...
 spawn(function()
	...
	Weapon:Toggle("Autolấy Pole V.1",_G.AutoPole,function(value)
        _G.AutoPole = value
        StopTween(_G.AutoPole)
    end)
    
    Weapon:Toggle("Auto lấy Pole V.1 Hop",_G.AutoPoleHop,function(value)
...
Weapon:Toggle("Nhiệm vụ tự động Bartilo",_G.Auto_Bartilo_Quest,function(value)
...
Weapon:Toggle("Auto lấy Evo Race [V2]",_G.Auto_Evo_Race_V2,function(value)
...
Weapon:Toggle("Auto thanh kiếm huyền thoại",_G.AutoBuyLegendarySword,function(Value)
...
Weapon:Seperator(" Haki Sắc Màu Cường Hóa ")

	Weapon:Toggle("Auto Buy cường hóa",_G.Auto_Buy_Enchancement,function(value)
...
Weapon:Toggle("Kính thiên nga ô tô",_G.Auto_Swan_Glasses,function(value)
 _G.Auto_Swan_Glasses = value
StopTween(_G.Auto_Swan_Glasses)
end)


	Weapon:Toggle("Kính thiên nga ô tô Hop",_G.Auto_Swan_Glasses_Hop,function(value)
 _G.Auto_Swan_Glasses_Hop = value
	...
	Weapon:Toggle("Cây đinh ba rồng tự động",_G.Auto_Dragon_Trident,function(value)
 _G.Auto_Dragon_Trident = value
StopTween(_G.Auto_Dragon_Trident)
end)

	
	Weapon:Toggle("Cây đinh ba rồng tự động Hop",_G.Auto_Dragon_Trident_Hop,function(value)
...
Weapon:Toggle("Auto  lấySoul Reaper",_G.Auto_Soul_Reaper,function(value)
 _G.Auto_Soul_Reaper = value
StopTween(_G.Auto_Soul_Reaper)
end)


Weapon:Toggle("Auto  lấy Soul Reaper Hop",_G.Auto_Soul_Reaper_Hop,function(value)
...
StopTween(_G.Auto_Soul_Reaper_Hop)
	...
	Weapon:Toggle("Auto lấy Yama",_G.Auto_Yama,function(value)
	 _G.Auto_Yama = value
	...
	Weapon:Toggle("Auto Haki cầu vồng",_G.Auto_Rainbow_Haki,function(value)
 _G.Auto_Rainbow_Haki = value
StopTween(_G.Auto_Rainbow_Haki)
end)

	
	Weapon:Toggle("AutoHaki cầu vồng",_G.Auto_Rainbow_Haki_Hop,function(value)
...
StopTween(_G.Auto_Rainbow_Haki_Hop)
	...
	Weapon:Toggle("Auto lấy Canvander",_G.Auto_Canvander,function(value)
 _G.Auto_Canvander = value
StopTween(_G.Auto_Canvander)
end)

	
	Weapon:Toggle("Auto lấy Canvander Hop",_G.Auto_Canvander_Hop,function(value)
...
StopTween(_G.Auto_Canvander_Hop)
	...
	spawn(function()
		...
		Weapon:Seperator(" móc đôi ")
	
	Weapon:Toggle("Auto móc đôi",_G.Auto_Twin_Hook,function(value)
 _G.Auto_Twin_Hook = value
StopTween(_G.Auto_Twin_Hook)
end)

	
	Weapon:Toggle("Automóc đôi Hop",_G.Auto_Twin_Hook_Hop,function(value)
...
Weapon:Toggle("Auto cung rắn",_G.Auto_Serpent_Bow,function(value)
 _G.Auto_Serpent_Bow = value
StopTween(_G.Auto_Serpent_Bow)
end)

	
	Weapon:Toggle("Auto cung rắn Hop",_G.Auto_Serpent_Bow_Hop,function(value)
...
Weapon:Toggle("Auto lấy Tushita Sword",_G.Autotushita,function(value)
...
Weapon:Toggle("Auto mũ lính ngự lâm",_G.Auto_Musketeer_Hat,function(value)
...
if World1 or World2 then
    Race:Label("Chỉ Có Ở Biển 3 hãy sang sev3 để hiện")
end
...
Race:Toggle("Cầu thang Inf dành cho người khuyết tật", nil, function(value)
...
P:Toggle("Tự động giết người chơi [Gun]",_G.Auto_Kill_Player_Gun,function(value)
...
if World1 then
    Dungeon:Label("mày chuyển qua se2 vs se3 mới mở chức năng này")
end
...
Dungeon:Toggle("Auto mở Start Dungeon",_G.Auto_StartRaid,function(value)
...
Dungeon:Toggle("Đảo tự động tiếp theo",_G.Auto_Next_Island,function(value)
...
Dungeon:Toggle("Giết Aura",_G.Kill_Aura,function(value)
 _G.Kill_Aura = value  
end)
...
spawn(function()
 ...
 _G.SelectFruit = ""
 DevilFruit:Dropdown("Chọn trái cây bắn tùm lum",FruitList,function(value)
  _G.SelectFruit = value
  end)
 
 DevilFruit:Toggle("Tự động mua trái cây bắn tùm lum",_G.AutoBuyFruitSniper,function(value)
  _G.AutoBuyFruitSniper = value
  end)
 
 DevilFruit:Seperator(" Others ")
 
 DevilFruit:Dropdown("Chọn trái cây ăn",FruitList,function(value)
  _G.SelectFruitEat = value
  end)
 
 DevilFruit:Toggle("Tự động ăn trái cây",_G.AutoEatFruit,function(value)
 ...
 DevilFruit:Toggle("Auto Random trái ác quỷ",_G.Random_Auto,function(value)
 ...
 DevilFruit:Toggle("Auto thả trái cây",_G.DropFruit,function(value)
  _G.DropFruit = value
  end)
 ...
 DevilFruit:Toggle("Auto cất Fruit",_G.AutoStoreFruit,function(value)
 ...
 DevilFruit:Toggle("lấy trái cây",_G.BringFruit,function(value)
  _G.BringFruit = value
  pcall(function()
 ...
 DevilFruit:Toggle("Dịch chuyển tức thời để lấy ra trái cây",false,function(value)
 _G.Grabfruit = value
end)
...
if World2 then
	...
	DevilFruit:Toggle("ESP hiện trên máp trái ác quỷ và trứng dái",false,function(a)
		DevilFruitESP = a
 ...
 Misc:Button("Tham gia đội cướp biển",function()
 		local args = {
			[1] = "SetTeam",
			[2] = "Pirates"
		}
...
Misc:Button("Tham gia đội thủy quân lục chiến",function()
 local args = {
			[1] = "SetTeam",
			[2] = "Marines"
		}
...
Misc:Toggle("Không có Clip",_G.No_clip,function(value)
 _G.No_clip = value
end)
...
Misc:Toggle("né tránh không có thời gian hồi chiêu",false,function(value)
    ...
    Misc:Toggle("Phạm vi quan sát vô hạn hehe",getgenv().InfiniteObRange,function(value)
